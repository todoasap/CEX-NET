...
namespace DTMClientTest
{
    internal class DtmClientTest
    {
        ...
        public void TestExchange()
        {
            ...
            DtmParameters cltDtmParams = DtmParamSets.FromName(DtmParamSets.DtmParamNames.X11RNS1R2); //.X32RNR1R1);       // preset contains all the settings required for the exchange
